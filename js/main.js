...
function loadDashboardData() {
    ...
    // Chart 1
    var json = '[{"SUM_Lost_Sales_Est":"136.2299","SKU_ID":"1"},{"SUM_Lost_Sales_Est":"28.5522","SKU_ID":"2"},{"SUM_Lost_Sales_Est":"2.3529","SKU_ID":"3"},{"SUM_Lost_Sales_Est":"38.3255","SKU_ID":"4"},{"SUM_Lost_Sales_Est":"4.9924","SKU_ID":"5"},{"SUM_Lost_Sales_Est":"21.0692","SKU_ID":"6"},{"SUM_Lost_Sales_Est":"6.9556","SKU_ID":"7"},{"SUM_Lost_Sales_Est":"45.6914","SKU_ID":"8"},{"SUM_Lost_Sales_Est":"20.1704","SKU_ID":"9"},{"SUM_Lost_Sales_Est":"97.0955","SKU_ID":"10"},{"SUM_Lost_Sales_Est":"97.0955","SKU_ID":"11"}]';
    // get array here
    var chart1 = JSON.parse(json);
    
    // Chart 2

    // Chart 3
    var json1 = '[{"Sales_Date": "2017-01-01","SUM_Lost_Sales_Est": "0.0000"},{"Sales_Date": "2017-01-02","SUM_Lost_Sales_Est": "0.0264"}]';
    var chart2 = JSON.parse(json1);

    // Chart 4 

    // Chart 5
    
    var dataArray = [chart1, chart2];
